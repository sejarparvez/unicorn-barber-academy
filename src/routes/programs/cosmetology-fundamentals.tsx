...
const program = BEAUTY_PROGRAMS.find(
	(p) => p.to === "/programs/cosmetology-fundamentals",
)!;

export const Route = createFileRoute("/programs/cosmetology-fundamentals")({
...
const CURRICULUM = [
	{
		week: "Weeks 1–3",
		title: "Skincare Foundations",
		topics: [
			"Skin anatomy, physiology & analysis",
			"Cleansing, exfoliation & extraction techniques",
			"Facial massage & lymphatic drainage",
			"Mask therapy & device basics (steamer, high-frequency)",
		],
	},
	{
		week: "Weeks 4–6",
		...
		topics: [
			"Colour theory & skin-tone matching",
			"Foundation selection & application techniques",
			"Contour, highlight & corrective makeup",
			"Eye & lip design for everyday & evening",
		],
	},
	{
		week: "Weeks 7–10",
		...
		topics: [
			"Blow-dry techniques & brush selection",
			"Thermal styling: curling, waving, straightening",
			"Updo foundations: pins, padding, securing",
			"Bridal & formal styling introduction",
		],
	},
	{
		week: "Weeks 11–13",
		...
		topics: [
			"Chemical exfoliation (AHA/BHA) protocols",
			"Microdermabrasion & LED therapy",
			"Acne, ageing & pigmentation treatment plans",
			"Retail product knowledge & home-care prescription",
		],
	},
	{
		week: "Weeks 14–16",
		...
		topics: [
			"Live client rotations: facials, makeup, styling",
			"Full look integration: skin + makeup + hair",
			"Mock practical exams (3 stations)",
...
const DETAILS = [
	...
	{ icon: IconAward, label: "Certification", value: "NTVQF Level 3" },
	{
		icon: IconScissors,
		label: "Kit Included",
		value: "Professional makeup & skincare set",
	},
];
	...
	return (
		<main>
			...
			<FinalCta
				...
				accent="Sixteen weeks. Three disciplines."
				subtitle="The only program that covers skin, makeup & hair in one certification. Next intake limited to 12 students."
			/>
		</main>
	);
}
	...
	return (
		<section className="relative overflow-hidden bg-secondary text-secondary-foreground">
			<div className="absolute inset-0 grid grid-cols-2">
				...
				/>
				<img
					src={pic("unicorn-cosmo-hero-2", 900, 1100)}
					alt=""
					className="h-full w-full object-cover opacity-40"
				/>
			</div>
