...
const program = BEAUTY_PROGRAMS.find(
	(p) => p.to === "/programs/hair-styling-and-colouring",
)!;

export const Route = createFileRoute("/programs/hair-styling-and-colouring")({
...
const CURRICULUM = [
	{
		week: "Weeks 1–2",
		title: "Colour Theory & Hair Science",
		topics: [
			"Colour wheel, level system & undertones",
			"Hair structure, porosity & elasticity",
			"Client consultation & strand testing",
			"Safety, PPE & chemical handling",
		],
	},
	{
		week: "Weeks 3–4",
		title: "Foundation Colour Techniques",
		topics: [
			"Virgin application & root retouch",
			"Global colour & toner formulation",
			"Demi-permanent vs. permanent choice",
			"Grey coverage strategies",
		],
	},
	{
		week: "Weeks 5–6",
		...
		topics: [
			"Highlights: foil, balayage, airtouch",
			"Colour correction: removal, fill, tone",
			"Creative colour: fashion shades, pastels",
			"Bond builders & damage management",
		],
	},
	{
		week: "Weeks 7–8",
		...
		topics: [
			"Sectioning, elevation & distribution",
			"One-length, graduation, layering",
			"Face-framing & texturising techniques",
			"Blow-dry & thermal finishing for colour",
		],
	},
];
...
const DETAILS = [
	...
	{ icon: IconAward, label: "Certification", value: "NTVQF Specialisation" },
	{
		icon: IconScissors,
		label: "Prerequisite",
		value: "Cosmetology Fundamentals or equivalent",
	},
];
...
function ProgramPage() {
	return (
		<main>
			...
			<Curriculum />
			<FinalCta
				title="Colour with confidence."
				accent="Eight weeks. Full-spectrum mastery."
				subtitle="From formulation to correction to creative colour. Next cohort capped at 12 — apply now."
			/>
		</main>
	);
}
	...
	return (
		<section className="relative overflow-hidden bg-secondary text-secondary-foreground">
			<div className="absolute inset-0 grid grid-cols-2">
				...
				/>
				<img
					src={pic("unicorn-hair-hero-2", 900, 1100)}
					alt=""
					className="h-full w-full object-cover opacity-40"
				/>
			</div>
