...
const program = BARBERING_PROGRAMS.find(
	(p) => p.to === "/programs/beard-sculpting",
)!;

export const Route = createFileRoute("/programs/beard-sculpting")({
...
const CURRICULUM = [
	{
		week: "Week 1",
		title: "Beard Anatomy & Consultation",
		topics: [
			"Growth patterns, density & patch management",
			"Face-shape analysis for beard design",
			"Client consultation & expectation setting",
			"Skin prep: cleansing, exfoliation, steaming",
		],
	},
	{
		week: "Week 2",
		title: "Line-Up Precision & Shape Design",
		topics: [
			"Cheek line, neck line, lip line fundamentals",
			"Symmetry techniques & reference points",
			"Straight-razor vs. trimmer for lines",
			"Design variations: square, rounded, angular",
		],
	},
	{
		week: "Week 3",
		title: "Sculpting & Bulk Removal",
		topics: [
			"Scissor-over-comb for beard shaping",
			"Clipper guard work for length management",
			"Blending sideburns into beard",
			"Mustache integration & styling",
		],
	},
	{
		week: "Week 4",
		title: "Hot-Towel Service & Finishing",
		topics: [
			"Traditional hot-towel ritual (3-towel method)",
			"Pre-shave oil, lather & post-shave balm",
			"Skin conditioning & ingrown prevention",
			"Retail product knowledge & client education",
		],
	},
];
	...
	return (
		<main>
			...
			<FinalCta
				...
				accent="Four weeks. Hot-towel mastery."
				subtitle="The most requested add-on service. Next cohort starts soon — limited to 12 seats."
			/>
		</main>
	);
}
	...
	return (
		<section className="relative overflow-hidden bg-secondary text-secondary-foreground">
			<div className="absolute inset-0 grid grid-cols-2">
				...
				/>
				<img
					src={pic("unicorn-beard-hero-2", 900, 1100)}
					alt=""
					className="h-full w-full object-cover opacity-40"
				/>
			</div>
