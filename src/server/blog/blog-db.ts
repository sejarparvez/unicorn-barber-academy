...
// Server-only data access for the blog_* tables (DDL owned by
// prisma/schema.prisma — never hand-write schema SQL).
...
export async function updatePost(
	...
	const updated = await withTransaction(async (tx) => {
		...
		// indexed links keep their rankings (see the BlogSlugRedirect model).
